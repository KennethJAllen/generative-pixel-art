# Proper Pixel Art 
## Summary
- Converts noisy, high resolution pixel-art-style images to true pixel resolution assets.

- Works on pixel-art-style images generated by LLMs, for example GPT-4o. Also works on screenshots of pixel art assets. 
...
5) Use [Hough transform](https://docs.opencv.org/3.4/d3/de6/tutorial_js_houghlines.html) to get the coordinates of lines in the detected edges. Only keep lines that are close to vertical or horizontal giving some grid coordinates. Cluster lines that are closeby together.
